// creates an obkect to keep track of values
const Calculator = {
...
function Input_Digit(digit) {
    ...
    //we are checking to see if Wait_Second_Operand is true to set
...
function Input_Decimal (dot) {
    //This ensures that accidentl clicking of the decminal point
